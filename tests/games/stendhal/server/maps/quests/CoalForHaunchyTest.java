...
public class CoalForHaunchyTest extends ZonePlayerAndNPCTestImpl {
	...
	public void testQuest2() {
		// This test checks the use of exclusively charcoal to complete the CoalForHaunchy quest.
		// The test process is the same as that of testQuest, but substituting "coal" for "charcoal".
		SpeakerNPC haunchy = SingletonRepository.getNPCList().get("Haunchy Meatoch");
		Engine haunchyEng = haunchy.getEngine();
