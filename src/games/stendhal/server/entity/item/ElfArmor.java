...
public class ElfArmor extends Item {
	
	public ElfArmor(final String name, final String clazz, final String subclass,
	...
	public ElfArmor(final ElfArmor armor) {
		super(armor);
	}
	
	@Override
	public String describe() {
		return "You see a suit of disguise armor. It disguises you from elves.";
	}
	
	// disguises you from enemies in nalwor zone (elves)
	@Override
	public boolean onEquipped (RPEntity equipper, String slot) {
		if (equipper instanceof Player) {
			...
			player.setDisguise("dark elf", zone.getName());
		}
