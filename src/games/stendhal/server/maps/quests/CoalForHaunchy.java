...
public class CoalForHaunchy extends AbstractQuest {
	...
	private void bringCoalStep() {
		...
		// player asks about quest or says coal when they are supposed to bring some coal and they have enough charcoal
		npc.add(
				ConversationStates.ATTENDING, triggers,
		...
		// player asks about quest or says coal when they are supposed to bring some coal and they don't have neither coal or charcoal
		npc.add(
				ConversationStates.ATTENDING, triggers,
				new AndCondition(new AndCondition(new QuestInStateCondition(QUEST_SLOT, "start"), new NotCondition(new PlayerHasItemWithHimCondition("coal",25))),
